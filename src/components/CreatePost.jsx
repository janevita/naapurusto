...
export default function CreatePost({ onClose, onSubmit, neighbourhood }) {
  ...
  function handleSubmit(e) {
    ...
    setSubmitted(true)
    setTimeout(() => {
      onSubmit({ type, title, body, anonymous: anon, neighbourhood: area })
      onClose()
    }, 1400)
  }
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="overflow-y-auto flex-1 px-4 py-4 space-y-4">
                    ...
                    <button
                      ...
                      className={`text-left p-3 rounded-xl border-2 transition-all
                        ${type === t.id
                          ...
                          : 'border-border bg-white hover:border-mid'}`}
                    >
              ...
              <div className="flex items-center justify-between py-1">
                ...
                >
                  <div className={`w-5 h-5 bg-white rounded-full absolute top-0.5 transition-all ${anon ? 'left-6.5' : 'left-0.5'}`}
