...
import { MOCK_IDEAS } from '../data/mock.js'
import { ArrowUpIcon, ChatIcon, CheckIcon } from './Icons.jsx'

export default function IdeasView({ neighbourhood }) {
      ...
      <div className="px-4 pt-4 space-y-3">
        ...
        {tab === 'voting' && (
          <div className="bg-gradient-to-r from-accent/20 to-mid/20 border border-accent/30 rounded-2xl p-4">
            <h3 className="font-bold text-dark text-sm mb-1">Have an idea for {neighbourhood === 'All Helsinki' ? 'your neighbourhood' : neighbourhood}?</h3>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-muted">
                      ...
                      {idea.budget && (
                        <span className="text-primary font-medium">{idea.budget}</span>
                      )}
                    </div>
